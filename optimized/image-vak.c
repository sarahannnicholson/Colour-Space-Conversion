...
void rgb_ycc_parallel(rgb_pixel* in, ycc_pixel* out){
...
ycc_data* rgb_to_ycc(rgb_data* inData, int height, int width){
  ...
  int j;
  int r1 = inData->data[0].r;
  int r2 = inData->data[1].r;
  int r3 = inData->data[2].r;
  int r4 = inData->data[3].r;

  int g1 = inData->data[0].g;
  int g2 = inData->data[1].g;
  int g3 = inData->data[2].g;
  int g4 = inData->data[3].g;

  int b1 = inData->data[0].b;
  int b2 = inData->data[1].b;
  int b3 = inData->data[2].b;
  int b4 = inData->data[3].b;
  for(j = 0; j < imageSize; j+=4){
    ...
    yccData->data[j].y  = 16 +  (( 16763*r1 +  32909*g1 +  6391*b1) >> 16);
    yccData->data[j].cb = 128 + (( -9676*r1 + -18996*g1 + 28672*b1) >> 16);
    yccData->data[j].cr = 128 + (( 28672*r1 + -24009*g1 + -4662*b1) >> 16);


    yccData->data[j+1].y  = 16 +  (( 16763*r2 +  32909*g2 +  6391*b2) >> 16);
    yccData->data[j+1].cb = 128 + (( -9676*r2 + -18996*g2 + 28672*b2) >> 16);
    yccData->data[j+1].cr = 128 + (( 28672*r2 + -24009*g2 + -4662*b2) >> 16);


    yccData->data[j+2].y  = 16 +  (( 16763*r3 +  32909*g3 +  6391*b3) >> 16);
    yccData->data[j+2].cb = 128 + (( -9676*r3 + -18996*g3 + 28672*b3) >> 16);
    yccData->data[j+2].cr = 128 + (( 28672*r3 + -24009*g3 + -4662*b3) >> 16);

    yccData->data[j+3].y  = 16 +  (( 16763*r4 +  32909*g4 +  6391*b4) >> 16);
    yccData->data[j+3].cb = 128 + (( -9676*r4 + -18996*g4 + 28672*b4) >> 16);
    yccData->data[j+3].cr = 128 + (( 28672*r4 + -24009*g4 + -4662*b4) >> 16);


    r1 = inData->data[j].r;
    g1 = inData->data[j].g;
    b1 = inData->data[j].b;
    r2 = inData->data[j+1].r;
    g2 = inData->data[j+1].g;
    b2 = inData->data[j+1].b;
    r3 = inData->data[j+2].r;
    g3 = inData->data[j+2].g;
    b3 = inData->data[j+2].b;
    r4 = inData->data[j+3].r;
    g4 = inData->data[j+3].g;
    b4 = inData->data[j+3].b;
  }

  yccData->data[imageSize-4].y  = 16 +  (( 16763*r1 +  32909*g1 +  6391*b1) >> 16);
  yccData->data[imageSize-4].cb = 128 + (( -9676*r1 + -18996*g1 + 28672*b1) >> 16);
  yccData->data[imageSize-4].cr = 128 + (( 28672*r1 + -24009*g1 + -4662*b1) >> 16);

  yccData->data[imageSize-3].y  = 16 +  (( 16763*r2 +  32909*g2 +  6391*b2) >> 16);
  yccData->data[imageSize-3].cb = 128 + (( -9676*r2 + -18996*g2 + 28672*b2) >> 16);
  yccData->data[imageSize-3].cr = 128 + (( 28672*r2 + -24009*g2 + -4662*b2) >> 16);

  yccData->data[imageSize-2].y  = 16 +  (( 16763*r3 +  32909*g3 +  6391*b3) >> 16);
  yccData->data[imageSize-2].cb = 128 + (( -9676*r3 + -18996*g3 + 28672*b3) >> 16);
  yccData->data[imageSize-2].cr = 128 + (( 28672*r3 + -24009*g3 + -4662*b3) >> 16);

  yccData->data[imageSize-1].y  = 16 +  (( 16763*r4 +  32909*g4 +  6391*b4) >> 16);
  yccData->data[imageSize-1].cb = 128 + (( -9676*r4 + -18996*g4 + 28672*b4) >> 16);
  yccData->data[imageSize-1].cr = 128 + (( 28672*r4 + -24009*g4 + -4662*b4) >> 16);
